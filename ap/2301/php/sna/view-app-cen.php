...
<html lang="en" class="loading">
  ...
  <head>
    ...
    <title>Approved Centres :: CUTM-AMASY</title>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Approved Centres List For <?=$scheme;?></h4>
          <p class="card-text">These are the centres that are already approved from State Nodal Agency of SEEDAP-AYS, the centes are ready for batch submission to CUTM.
          </p>
        </div>
...
$result ="SELECT * FROM centers WHERE opr_state='$name' AND cen_status ='Approved'";
