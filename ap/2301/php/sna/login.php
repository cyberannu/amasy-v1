...
<html lang="en" class="loading">
  ...
  <head>
    ...
    <meta name="description" content="Assessment Management System">
    <meta name="keywords" content="admin template, Apex admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title>Login :: SNA Login</title>
...
<section id="login">
 <form method="POST" action="scripts/login-verify.php">
            ...
            <div class="card-body login-img">
              <div class="row m-0">
                ...
                <div class="col-lg-6 col-md-12 bg-white px-4 pt-3">
                  <h4 class="mb-2 card-title">SNA Login</h4>
                  <p class="card-text mb-3">
                    Welcome back, please login to your account.
                  </p>
                  <input type="text" class="form-control mb-3" placeholder="Username" name="username" />
                  <input type="password" class="form-control mb-1" placeholder="Password" name="password" />
                  <input type="hidden" class="form-control" name="role" value ="State Nodal Agency" readonly>
                  ...
                  <div class="fg-actions d-flex justify-content-between">
                    <div class="login-btn">
                      <button class="btn btn-outline-primary">
                        <a href="" class="text-decoration-none">Request Credentials</a>
                      </button>
                    </div>
                    <div class="recover-pass">
                        <input type="submit" class="btn btn-primary btn-block text-decoration-none text-white" value="Login">
                    </div>
                  </div>
                  <hr class="m-0">
                  <div class="d-flex justify-content-between mt-3">
                    <div class="option-login">
                      <h6 class="text-decoration-none text-primary">Knowledgebase</h6>
                    </div>
					</form>
                  </div>
                </div>
