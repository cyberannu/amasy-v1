...
<html lang="en" class="loading">
  ...
  <head>
    ...
    <title>All Batches  Certificate:: CUTM-AMASY</title>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">All Batches Certificate For <?=$scheme;?></h4>
          <p class="card-text">These are all the batches certificates for State Nodal Agency of SEEDAP-AYS, the batches are approved for assessment completion or in process of completion soon.
          </p>
        </div>
...
$result=mysqli_query($con,$result);
    ...
    echo "<div style='overflow:auto;'><table id='example' class='table table-striped table-bordered hide-columns-dynamically'><thead><tr><th>Center ID</th><th>Center Name</th><th>ABN No.</th><th>Assesment Date</th><th>Batch ID</th><th>Status</th><th>Batch View Details</th></tr></thead>";
        ...
        echo "<tr><td>".$row["center_id"]."</td><td>".$row["cen_name"]."</td><td>".$row["pr_abn_no"]."</td><td>".$row["pr_as_dt"]."</td><td>".$row["pr_btchid"]."</td><td>".$row["btch_status"]."</td><td><a href='view-batch-certificate.php?pr_abn_no=".$row["pr_abn_no"]."'>View Details</a></td></tr>";
    }
    echo "</div></table>";
