...
<html lang="en" class="loading">
  ...
  <head>
    ...
    <title>Rejected Batches :: CUTM-AMASY</title>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Rejected Batches For <?=$scheme;?></h4>
          <p class="card-text">These are the batches are already rejected from State Nodal Agency of SEEDAP-AYS, the batches are either rejected for assessment process due to data disperancies or mismatch.
          </p>
        </div>
...
$sch = $_GET['scheme'];													
$result ="SELECT * FROM btch_1 a INNER JOIN centers b ON a.cen_name = b.cen_name and b.opr_state='$name' AND b.scheme = 'SEEDAP-AYS' where a.btch_status ='Rejected' AND a.cnf_status = 'Yes'";
$result=mysqli_query($con,$result);
    ...
    echo "<center><h4>No Rejected Batches Till Now</h4></center>";
}
mysqli_close($con);
?>
          </div>
