    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">All Batches For <?=$scheme;?></h4>
          <p class="card-text">These are all the batches deatils for State Nodal Agency of SEEDAP-AYS, the batches are either pending, approved for assessment completion or in process of completion soon.
          </p>
        </div>
...
$sch = $_GET['scheme'];													
$result ="SELECT * FROM btch_1 a INNER JOIN centers b ON a.cen_name = b.cen_name and b.opr_state='$name' AND b.scheme = 'SEEDAP-AYS' where a.cnf_status = 'Yes'";
