...
<html lang="en" class="loading">
  ...
  <head>
    ...
    <title>All Centres :: CUTM-AMASY</title>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">All Centres For Actions From <?=$scheme;?></h4>
          <p class="card-text">These are all the centres details for actions to be taken by State Nodal Agency of SEEDAP-AYS, the Centres are either pending, approved for assessment completion or in process of completion soon.
          </p>
        </div>
...
$result ="SELECT * FROM centers WHERE opr_state='$name'";
$result=mysqli_query($con,$result);
    ...
    echo "<div style='overflow:auto;'><table id='example' class='table table-bordered mb-0'><thead><tr><th>Center ID</th><th>Center Name</th><th>Contact Person</th><th>Contact Mobile No</th><th>Previous SNA Status</th><th>Current SNA Status</th><th>View Details</th></tr></thead>";
        ...
        echo "<tr><td>".$row["center_id"]."</td><td>".$row["cen_name"]."</td><td>".$row["poc_name"]."</td><td>".$row["poc_mob"]."</td><td>".$row["cen_status"]."</td><td>".$row["sna_status"]."</td><td><a href='centre-actions.php?center_id=".$row["center_id"]."''>View Details</a></td></tr>";
    }
    echo "</div></table>";
