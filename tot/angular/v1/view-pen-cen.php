...
<html lang="en" class="loading">
  ...
  <head>
    ...
    <title>Pending Centres :: CUTM-AMASY</title>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Pending Centres List For <?=$scheme;?></h4>
          <p class="card-text">These are the centres that are Waiting for approval from State Nodal Agency of SEEDAP-AYS,post approval the centes are ready for batch submission to CUTM.
          </p>
        </div>
...
$result ="SELECT * FROM centers WHERE opr_state='$name' AND cen_status ='Pending'";
