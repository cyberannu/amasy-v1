    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Approved Batches For <?=$scheme;?></h4>
...
$result=mysqli_query($con,$result);
    ...
    echo "<div style='overflow:auto;'><table id='example' class='table table-striped table-bordered hide-columns-dynamically file-export'><thead><tr><th>Center ID</th><th>Center Name</th><th>ABN No.</th><th>Assesment Date</th><th>Batch ID</th><th>Status</th><th>Batch View Details</th></tr></thead>";
             while($row = mysqli_fetch_array($result))  { 
        echo "<tr><td>".$row["center_id"]."</td><td>".$row["cen_name"]."</td><td>".$row["pr_abn_no"]."</td><td>".$row["pr_as_dt"]."</td><td>".$row["pr_btchid"]."</td><td>".$row["btch_status"]."</td><td><a href='view-batch-details.php?pr_abn_no=".$row["pr_abn_no"]."'>View Details</a></td></tr>";
    }
    echo "</div></table>";
