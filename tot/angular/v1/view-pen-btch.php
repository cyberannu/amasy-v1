...
<html lang="en" class="loading">
  ...
  <head>
    ...
    <title>Pending Batches:: CUTM-AMASY</title>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Pending Batches For <?=$scheme;?></h4>
...
$sch = $_GET['scheme'];													
$result ="SELECT * FROM btch_1 a INNER JOIN centers b ON a.cen_name = b.cen_name and b.opr_state='$name' AND b.scheme = 'SEEDAP-AYS' where a.btch_status ='Pending' AND a.cnf_status = 'Yes'";
$result=mysqli_query($con,$result);
    ...
    echo "<center><h4>No Batches For Approval in Que For Now</h4></center>";
}
mysqli_close($con);
?>
          </div>
